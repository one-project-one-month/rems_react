...
type UseGetAppointmentHistoryQueryResult = ReturnType<typeof appointmentApi.useGetAppointmentHistoryQuery>;

// Export with explicit type
export const useGetAppointmentHistoryQuery: () => UseGetAppointmentHistoryQueryResult = appointmentApi.useGetAppointmentHistoryQuery;

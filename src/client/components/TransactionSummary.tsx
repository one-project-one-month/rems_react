            ...
            <div className='grid grid-cols-12 gap-3 md:gap-8 max-w-full'>
                <div className='col-span-12 md:col-span-4 space-y-3 md:space-y-5'>
                    <div className='text-center rounded-md'>
                        ...
                        <p className='bg-zinc-200 px-3 text-[.9rem] text-zinc-500 mx-20 rounded-sm md:mx-0 py-1'>Iris Fleur</p>
                    </div>
                    <div className='text-center rounded-md'>
                        <h5 className='text-[1.1rem] font-semibold pb-1 text-zinc-600'>Transaction: </h5>
                        <p className='bg-zinc-200 px-3 text-[.9rem] py-1 text-zinc-500 mx-20 rounded-sm md:mx-0'>Rent</p>
                    </div>
                    <div className='text-center rounded-md'>
                        <h5 className='text-[1.1rem] font-semibold pb-1 text-zinc-600'>Agent: </h5>
                        <p className='bg-zinc-200 px-3 text-[.9rem] py-1 text-zinc-500 mx-20 rounded-sm md:mx-0'>David John</p>
                    </div>
                </div>
